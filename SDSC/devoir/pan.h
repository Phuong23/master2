...
#define nstates4	14	/* somCorrecte */
#define minseq4	70
#define maxseq4	82
#define endstate4	13

#define nstates3	14	/* connaisSom */
#define minseq3	57
#define maxseq3	69
#define endstate3	13

#define nstates2	14	/* protocTermi */
#define minseq2	44
#define maxseq2	56
#define endstate2	13

#define nstates1	9	/* :init: */
#define minseq1	36
#define maxseq1	43
#define endstate1	8

#define nstates0	37	/* noeud */
#define minseq0	0
#define maxseq0	35
#define endstate0	36
...
#define Air1	(sizeof(P1) - Offsetof(P1, c91) - 1*sizeof(uchar))

#define Pnoeud	((P0 *)this)
typedef struct P0 { /* noeud */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, somme) - 1*sizeof(int))
