...
#define Pfiltre	((P0 *)this)
typedef struct P0 { /* filtre */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
	unsigned _priority : 8; /* 0..255 */
#endif
	unsigned lastCreated : 1;
	uchar cin;
	uchar cout;
	int n;
	int r;
} P0;
#define Air0	(sizeof(P0) - Offsetof(P0, r) - 1*sizeof(int))
